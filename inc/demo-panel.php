<div class="demo-wrapper">
    ...
    <div class="demo">
        ...
        <div class="content">
            ...
            <input type="text" class="wp-color-picker accent-color" value="#4B63B0" data-default-color="#4B63B0" />
            
            <div class="text-label"><?php _e('Menu',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker menu-color" value="#706771" data-default-color="#706771" />
            
            <input type="text" class="wp-color-picker menu-text-color" value="#FFFFFF" data-default-color="#FFFFFF" />
            
            <input type="text" class="wp-color-picker submenu-text-color" value="#BEB0BF" data-default-color="#BEB0BF" />    
            
            <div class="text-label"><?php _e('Random Button',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker random-color" value="#B5ADB6" data-default-color="#B5ADB6" />            
                        
            <div class="text-label"><?php _e('Top Ten',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker topten-color" value="#4B63B0" data-default-color="#4B63B0" />
            
            <input type="text" class="wp-color-picker topten-text-color" value="#FFFFFF" data-default-color="#FFFFFF" />  
            
            <div class="text-label"><?php _e('Social',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker social-color" value="#4B63B0" data-default-color="#4B63B0" />  
            
            <input type="text" class="wp-color-picker social-text-color" value="#FFFFFF" data-default-color="#FFFFFF" /> 
            ...
            <div class="flatten-buttons">
            
            	<div class="text-label"><?php _e('Background Styles',IT_TEXTDOMAIN); ?></div>
            
            	<button class="btn btn-mini background-overlay" type="button"><?php _e( 'Background Overlay',IT_TEXTDOMAIN ); ?></button>
                <button class="btn btn-mini background-overlay remove-overlay" type="button" data-images="<?php echo THEME_IMAGES; ?>"><?php _e( 'Remove Overlay',IT_TEXTDOMAIN ); ?></button>   
            
            	<button class="btn btn-mini flatten-menu" type="button"><?php _e( 'Flatten Menu',IT_TEXTDOMAIN ); ?></button>
                <button class="btn btn-mini flatten-menu unflatten-menu" type="button" data-images="<?php echo THEME_IMAGES; ?>"><?php _e( 'Unflatten Menu',IT_TEXTDOMAIN ); ?></button>       
            
            	<button class="btn btn-mini flatten-topten" type="button"><?php _e( 'Flatten Top Ten',IT_TEXTDOMAIN ); ?></button>
                <button class="btn btn-mini flatten-topten unflatten-topten" type="button" data-images="<?php echo THEME_IMAGES; ?>"><?php _e( 'Unflatten Top Ten',IT_TEXTDOMAIN ); ?></button>
            ...
            <a href="http://www.industrialthemes.com/flavor/support/" class="btn btn-inverse btn-small more-options"><?php _e('More Theme Info',IT_TEXTDOMAIN); ?><span class="icon-right-thin"></span></a>                
