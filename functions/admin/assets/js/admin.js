...
var alliAdmin = {
	...
	customDropdowns : function() {
		...
		if( isIE ){
			jQuery('.typography_option_set .it_option').append('<iframe class="fontiehack" src="javascript:false;" marginwidth="0" marginheight="0" align="bottom" scrolling="no" frameborder="0" style="position:absolute; right:0; top:0px; display:block; filter:alpha(opacity=0);"></iframe><div class="font_select"></div>');
		}else{
